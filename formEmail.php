...
if (isset($_POST['submit'])) {
    ...
    $from = "contacto@miroservicios.cl"; // Email con el dominio del Hosting para evitar SPAM
    $fromName = "MIRO EMAIL WEBSITE"; // Nombre que saldrá en el email recibido
    $to = "contacto@miroservicios.cl"; // Dirección donde se enviará el formulario
